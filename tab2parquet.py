...
null_values = ["","#N/A","#N/AN/A","-1.#IND","-1.#QNAN","-NaN","-nan","1.#IND","1.#QNAN","N/A","NULL","NaN","n/a","nan","null","\\N"]

try:
	table = csv.read_csv(input_table, parse_options = csv.ParseOptions(delimiter='\t'), 
		read_options = csv.ReadOptions(autogenerate_column_names = True),
		convert_options = csv.ConvertOptions(null_values = null_values, strings_can_be_null = True) ) 
